...
public class BA2 {
    public static void main(String[] args) {
        ...
        int newDiscipleAge = 21; // Age when disciples can start training new disciples
        ...
        while (disciples.compareTo(BigInteger.ZERO) > 0) {
            ...
            // Checks if there is a couple of disciples who are both 30 years old
            if (years >= 30) {
            ...
            // Remove disciples when they reach the age of 72 because they died :(
            if (years % 72 == 0) {
